...
#
# 2010.10.26
# -- Function to generate citation is now a method, gen_citation, rather
#    than a language-specific function attribute.
# 2010.10.31
# -- Fixed POSMorphology.load_fst() so it inverts the analysis FST
#    for generation when there isn't an explicit generation FST.
# 2013.08.30
# -- Added POSMorphology.segment() for segmenting words into affix+modified word
#    given particular feature values.
...
class POSMorphology:
    """FSTs for analysis and generation of words in a particular POS class."""
...
#                self.casc_inv.reverse()
    ...
    def gen(self, root, features=None, from_dict=False, postproc=False, update_feats=None,
            guess=False, simplified=False, phon=False, segment=False,
            fst=None, timeit=False, trace=False):
